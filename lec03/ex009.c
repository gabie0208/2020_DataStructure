...
each term of a polynomial include; exponent and coefficient
does not need to store terms tha thave zero coefficient
...
// shared momery for storing polynomials
