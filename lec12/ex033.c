...
//유저 인풋을 받아서 매트릭스 보여주기
//time complexity : o(num_rows+num_cols+num_terms)
matrix_pointer mread() {
...
//time complexity: o(num_rows+num_terms)
void mwrite(matrix_pointer node) {
